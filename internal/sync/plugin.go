...
// SyncPlugin defines the unified interface for sync plugins (export/import)
type SyncPlugin interface {
	...
	// Import Operations
	Import(ctx context.Context, source ImportSource, config ImportConfig) (*ImportResult, error)
