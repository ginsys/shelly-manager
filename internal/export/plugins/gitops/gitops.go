...
// GitOpsExporter implements the ExportPlugin interface for GitOps YAML exports
type GitOpsExporter struct {
	logger *logging.Logger
}

// NewGitOpsExporter creates a new GitOps exporter
func NewGitOpsExporter() *GitOpsExporter {
	return &GitOpsExporter{}
}

// Info returns plugin information
func (g *GitOpsExporter) Info() export.PluginInfo {
	return export.PluginInfo{
		...
		Category: export.CategoryGitOps,
	}
}

// ConfigSchema returns the configuration schema
func (g *GitOpsExporter) ConfigSchema() export.ConfigSchema {
	return export.ConfigSchema{
		Version: "1.0",
		Properties: map[string]export.PropertySchema{
			"output_path": {
				Type:        "string",
...
func (g *GitOpsExporter) ValidateConfig(config map[string]interface{}) error {
...
func (g *GitOpsExporter) Export(ctx context.Context, data *export.ExportData, config export.ExportConfig) (*export.ExportResult, error) {
	startTime := time.Now()
...
func (g *GitOpsExporter) Preview(ctx context.Context, data *export.ExportData, config export.ExportConfig) (*export.PreviewResult, error) {
	groupBy, _ := config.Config["group_by"].(string)
	if groupBy == "" {
		groupBy = "location"
	}
...
func (g *GitOpsExporter) Capabilities() export.PluginCapabilities {
	return export.PluginCapabilities{
...
func (g *GitOpsExporter) Initialize(logger *logging.Logger) error {
	g.logger = logger
...
func (g *GitOpsExporter) Cleanup() error {
...
func (g *GitOpsExporter) groupDevices(devices []export.DeviceData, groupBy string, groupMapping interface{}) map[string][]export.DeviceData {
	groups := make(map[string][]export.DeviceData)
...
func (g *GitOpsExporter) groupDevicesByType(devices []export.DeviceData) map[string][]export.DeviceData {
	groups := make(map[string][]export.DeviceData)
...
func (g *GitOpsExporter) extractLocationFromName(name string) string {
...
func (g *GitOpsExporter) getCustomGroup(deviceName string, groupMapping interface{}) string {
...
func (g *GitOpsExporter) getUngroupedDevices(allDevices []export.DeviceData, groups map[string][]export.DeviceData) []export.DeviceData {
	...
	var ungrouped []export.DeviceData
...
func (g *GitOpsExporter) generateCommonConfig(data *export.ExportData) map[string]interface{} {
...
func (g *GitOpsExporter) generateGroupConfig(groupName string, devices []export.DeviceData, data *export.ExportData) map[string]interface{} {
	return map[string]interface{}{
...
func (g *GitOpsExporter) generateTypeCommonConfig(deviceType, groupName string) map[string]interface{} {
	return map[string]interface{}{
...
func (g *GitOpsExporter) generateDeviceConfig(device export.DeviceData, excludeFields []string) map[string]interface{} {
...
func (g *GitOpsExporter) parseExcludeFields(fieldsInterface interface{}) []string {
	var fields []string
...
func (g *GitOpsExporter) sanitizeFilename(name string) string {
...
func (g *GitOpsExporter) writeYAMLFile(filePath string, data interface{}) error {
...
func (g *GitOpsExporter) calculateDirectorySize(dirPath string) (int64, error) {
	var totalSize int64
...
func (g *GitOpsExporter) generatePreviewStructure(groups map[string][]export.DeviceData, data *export.ExportData) string {
