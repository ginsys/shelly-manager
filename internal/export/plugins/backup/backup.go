...
// BackupExporter implements the ExportPlugin interface for database backups
type BackupExporter struct {
	dbManager DatabaseManagerInterface
	logger    *logging.Logger
}

// NewBackupExporter creates a new backup exporter
func NewBackupExporter(dbManager DatabaseManagerInterface) *BackupExporter {
...
func (b *BackupExporter) Info() export.PluginInfo {
	return export.PluginInfo{
		...
		Category: export.CategoryBackup,
	}
}

// ConfigSchema returns the configuration schema
func (b *BackupExporter) ConfigSchema() export.ConfigSchema {
...
func (b *BackupExporter) ValidateConfig(config map[string]interface{}) error {
...
func (b *BackupExporter) Export(ctx context.Context, data *export.ExportData, config export.ExportConfig) (*export.ExportResult, error) {
	startTime := time.Now()
...
func (b *BackupExporter) Preview(ctx context.Context, data *export.ExportData, config export.ExportConfig) (*export.PreviewResult, error) {
...
func (b *BackupExporter) Capabilities() export.PluginCapabilities {
...
func (b *BackupExporter) Initialize(logger *logging.Logger) error {
	b.logger = logger
...
func (b *BackupExporter) Cleanup() error {
	b.logger.Info("Cleaning up backup exporter plugin")
	return nil
}

// RestoreBackup restores a backup file
func (b *BackupExporter) RestoreBackup(ctx context.Context, backupPath string, options map[string]interface{}) (*export.ImportResult, error) {
	startTime := time.Now()
...
func (b *BackupExporter) ValidateBackup(ctx context.Context, backupPath string) (*provider.ValidationResult, error) {
...
func (b *BackupExporter) calculateChecksum(filePath string) (string, error) {
