...
// GetInterfaceInfo returns information about the mock network interface
func (ni *MockNetworkInterface) GetInterfaceInfo() NetworkInterfaceInfo {
	return NetworkInterfaceInfo{
		Name:         "mock-wlan0",
		Type:         "wireless",
		Tooling:      "mock (testing/development)",
